...
| `CLOUDFLARE_API_TOKEN` | No | Read-only Cloudflare D1 token. When configured, the deploy workflow validates and syncs this from the matching GitHub Actions secret. |
